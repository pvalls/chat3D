...
// 			if(Usuario.cube.position.x < (planeWidth/2 - step)){
// 				Usuario.cube.position.x+=step;
// 				sendPosition();
// 				//redraw();
// 			}
// 		break;
...
// 			if(Usuario.cube.position.y > (-planeHeight/2 +step)){
// 				Usuario.cube.position.y-=step;
// 				sendPosition();
// 			//redraw();
// 			}
// 		break;
